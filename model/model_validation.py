...
if __name__ == '__main__':
    ...
    dc_station_17_poisson = fetch_station("Washington, D.C.", stationid)

    start_date = "02/16/2012"
    print >> sys.stderr, "Running model validation script for poisson."
    model_validation(poisson_fit, 25, dc_station_17_poisson, stationid, start_date)

# <codecell>
    dc_station_17_binomial = fetch_station("Washington, D.C.", stationid, 15, 'max')
    print >> sys.stderr, "Running model validation script for binomial."
    model_validation(binomial_fit, 25, dc_station_17_binomial, stationid, start_date)
